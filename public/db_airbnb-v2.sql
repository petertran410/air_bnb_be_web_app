...
(3135, 'Quận 8', 'Hồ Chí Minh', 'Việt Nam', NULL);

INSERT INTO `reservations` (`id`, `reserved_by_id`, `room_id`, `guests`, `arrival`, `departure`) VALUES
(27, 25, 12, 3, '2024-06-15 00:00:00', '2024-06-17 00:00:00');
INSERT INTO `reservations` (`id`, `reserved_by_id`, `room_id`, `guests`, `arrival`, `departure`) VALUES
(28, 25, 8, 8, '2024-06-15 00:00:00', '2024-06-20 00:00:00');
INSERT INTO `reservations` (`id`, `reserved_by_id`, `room_id`, `guests`, `arrival`, `departure`) VALUES
(35, 32, 3, 1, '2024-06-16 00:00:00', '2024-06-17 00:00:00');
INSERT INTO `reservations` (`id`, `reserved_by_id`, `room_id`, `guests`, `arrival`, `departure`) VALUES
(36, 32, 4, 1, '2024-06-16 00:00:00', '2024-06-22 00:00:00');
...
(13, 'Cozzy', 2, 50, 'Phòng rất và đầy đủ tiện nghi cùng với đó là giá thành rất rẻ ...', 'https://i.pinimg.com/736x/a8/64/74/a86474919230fead67e6704203aa5fb7.jpg', 1, 1, 1, 1, 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true'),
(19, 'Get high', 2, 100, 'Phòng đẹp', 'https://i.pinimg.com/originals/16/a3/76/16a3769d6df1f5e82031a94af10dec25.jpg', 1, 1, 2, 2, 'false', 'true', 'false', 'false', 'false', 'true', 'false', 'false');

INSERT INTO `users` (`id`, `avatar`, `name`, `email`, `password`, `phone`, `birthday`, `gender`, `role`) VALUES
(1, NULL, 'Administrator', 'admin1@gmail.com', '$2b$10$MjA/s7/AGN9on3qzeHvPCOvbvLd0hMUF9aK1pmemrk8g9oHDLcvR6', '09876543212', '2222-01-02', 'Female', 'Guest');
INSERT INTO `users` (`id`, `avatar`, `name`, `email`, `password`, `phone`, `birthday`, `gender`, `role`) VALUES
...
INSERT INTO `users` (`id`, `avatar`, `name`, `email`, `password`, `phone`, `birthday`, `gender`, `role`) VALUES
(25, NULL, 'Tran Ngoc Nhan', 'nhantran4102002@gmail.com', '$2b$10$/KhXDbst.AwBmALB3QM6L.eqb0SljuHvVZ5DCm62yufa7OQPcpRLq', '090909090', '2002-03-10', 'Male', 'Admin');
INSERT INTO `users` (`id`, `avatar`, `name`, `email`, `password`, `phone`, `birthday`, `gender`, `role`) VALUES
(26, NULL, 'Datio', 'Datio@gmail.com', '$2b$10$q8TLCCwQ4rJ2Yr3vN3GWQ.xYsjchUnAn9GvtoH8eCmAtphS3RmV.S', '123', '2024-01-01', 'Male', 'Guest'),
(27, NULL, 'Imdeadinside', 'nhan1@gmail.com', '$2b$10$SVbZo.ie1SefhKczoSAcI.uJzw8OeDRomCMaMqWP/b1xgOg.lpqZy', '11', '2024-01-01', 'Female', 'Guest'),
(28, NULL, 'ImDeadinSide', 'imdeadinside3@gmail.com', '$2b$10$mljpNZqSrU7mEp4HZqD1OuSDN6Cg9e9Srp0MaV9gZOf9GQlzqfdVu', '112233', '2002-04-10', 'Male', 'Guest'),
(29, NULL, 'Cozzy', 'cozzy@gmail.com', '$2b$10$u0Wqqn5jInYylTpeTWBsI.7LghtyDHZulZrT0cDxE4RWkZONz41q6', '334455', '2003-07-03', 'Female', 'Guest'),
(32, NULL, 'Spider Man', 'spider@gmail.com', '$2b$10$tHZGsK/K90gLoxPaEfSbd.5xc6zquIAxrc96Z/8u0zAF1lPy6hfyS', '121212', '2002-11-11', 'Female', 'Guest');
